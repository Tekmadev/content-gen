...
const CANVA_SCOPES =
  "design:content:read design:content:write asset:read asset:write export:read";
...
export async function GET() {
  ...
  const redirectUri = `${process.env.NEXT_PUBLIC_APP_URL ?? "https://content.tekmadev.com"}/api/canva/callback`;
